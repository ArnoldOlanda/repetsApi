...
router.post(
  ...
  [
    ...
    check('tipo_mascotas', 'El campo debe ser un id de categoria valido')
      .not()
      .isEmpty(), //Tipo mascota
...
router.put(
  ...
  [
    ...
    check('direccion', 'El campo es obligatorio').not().isEmpty(),
    check('coordenadas', 'El campo debe ser un objeto').isObject(),
    check('celular', 'El campo debe contener al menos 9 digitos').isLength({
      min: 9,
    }),
