...
exports.existeUsuarioId = exports.emailExiste = void 0;
const usuario_1 = __importDefault(require("../models/usuario"));
//Validar correo si existe
const emailExiste = (_correo) => __awaiter(void 0, void 0, void 0, function* () {
...
const existeUsuarioId = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const existe = yield usuario_1.default.buscar(id);
    if (!existe)
