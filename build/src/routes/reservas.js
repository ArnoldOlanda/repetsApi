...
router.post('/', [
    (0, express_validator_1.check)('fecha_solicitud').not().isEmpty(),
    (0, express_validator_1.check)('fecha_reserva').not().isEmpty(),
    ...
    (0, express_validator_1.check)('mascota').isMongoId(),
    (0, express_validator_1.check)('mascota').custom(dbValidator_1.existePetId),
